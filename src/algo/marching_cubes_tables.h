...
/* Maps vertex sign mask to edge zero-crossing mask. In my
 implementation this table is not needed, but it is used in
 debug config to verify that supplied grid is correct. */
...
/* Maps vertex sign mask to triangle indices list in the cell.
 -1 means end of the list. This table is written by Geoffrey Heller. */
static const int triTable[256][13] = {
